...
switch Dataset
    ...
    case {'Caltech101'}
        ...
        %             my_ind=find(labelMat(i,:));
        %             rand_ind=randperm(length(my_ind),30);
        %             train_ind=my_ind(rand_ind);
        %             test_ind=setdiff(my_ind,train_ind);
        %             training_feats=[training_feats,featureMat(:,train_ind)];
        %             H_train=[H_train,labelMat(:,train_ind)];
        %             testing_feats=[testing_feats,featureMat(:,test_ind)];
        %             H_test=[H_test,labelMat(:,test_ind)];
        %         end
    ...
    case {'CIFAR-100'}
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %   CIFAR-100 database
        %   Data_dimension=3072, Sample_number=50000(train)+10000(test), Label_number=20(coarse)/100(fine)
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        training_feats=train_x(:,1:Train_num);
        testing_feats=test_x(:,1:Test_num);
        H_train=train_y_fine(:,1:Train_num);
        H_test=test_y_fine(:,1:Test_num);
    ...
    case {'CIFAR-100-20'}
        ...
        training_feats=train_x(:,1:Train_num);
        testing_feats=test_x(:,1:Test_num);
        H_train=train_y_coarse(:,1:Train_num);
        H_test=test_y_coarse(:,1:Test_num);
        
    case {'SVHN'}
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %   SVHN database
        %   Data_dimension=3072, Sample_number=73257(train)+26032(test), Label_number=10
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
